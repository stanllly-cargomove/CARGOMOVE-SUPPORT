...
5. In Supabase Authentication, create the matching `admin@cargomove.local` user. Do not insert directly into `auth.users` with SQL; Auth needs to create its identity and session data.
