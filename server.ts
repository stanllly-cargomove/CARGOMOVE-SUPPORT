...
app.get('/api/support/automation', automationRules);
app.post('/api/support/automation', automationRules);
app.put('/api/support/automation', automationRules);
app.post('/api/support/automation-run', automationRun);
app.get('/api/support/analytics', supportAnalytics);
app.get('/api/support/learning', learningList);
app.get('/api/support/learning-detail', learningDetail);
app.post('/api/support/learning', learningWrite);
app.get('/api/support/delivery', deliveryRead);
app.post('/api/support/delivery', deliveryWrite);
app.post('/api/support/delivery-check', deliveryReconcile);
app.post('/api/support/case-status', caseStatus);
app.get('/api/support/reply', replyRead);
app.put('/api/support/reply', replyEdit);
app.post('/api/support/generate-reply', replyGenerate);
app.get('/api/support/knowledge', knowledgeArticles);
app.post('/api/support/knowledge', knowledgeArticles);
app.put('/api/support/knowledge', knowledgeArticles);
app.get('/api/support/knowledge-matches', knowledgeMatches);
